#!/bin/bash
#SBATCH --job-name=cs396-pp-pt
#SBATCH --output=output/cs396_pp_pt_%j.out
#SBATCH --error=output/cs396_pp_pt_%j.err
...
python /projects/b1170/users/kyx8046/CS396/CS396_PP_pt.py "$@"
